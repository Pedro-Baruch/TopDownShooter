...
// Define o movimento do chunk quando o inimigo morrer
...
// Fazer eles olharem pra direção que estão indo
enemy_chunk_look = function(_direction){
	direction = _direction
	image_angle = direction // Fazendo ele olhar pra direção que nasceu
}

// Fazer ele perder velocidade com o tempo até fica iguala 0
...
// Fazer ficar transparente e depois se destruir
